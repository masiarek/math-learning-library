...
|---|---|---|
| SG105 *Enter rate … rate type M for … in the system settings* | No rate found by the search order | [Exchange rates](../exchange_rates/README.md) |
| F5 373 *Exchange rate … deviates from table rate … by … %* | Manual rate outside the tolerance (OB64 / TCURD) | [Exchange rates](../exchange_rates/README.md) |
